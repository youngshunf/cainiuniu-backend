...
-- 自动生成于: 2026-01-28 17:38:29.898952
...
BEGIN
    ...
    IF v_menu_id IS NULL THEN
        INSERT INTO sys_menu (title, name, path, sort, icon, type, component, perms, status, display, cache, link, remark, parent_id, created_time, updated_time)
        VALUES ('积分交易记录管理', 'CreditTransaction', '/user_tier/credit_transaction', 1, 'lucide:list', 1, '/user_tier/credit_transaction/index', NULL, 1, 1, 1, '', '积分交易记录表', v_parent_id, NOW(), NULL)
