...
class User(Base):
    ...
    # 扩展用户资料字段
    gender: Mapped[str | None] = mapped_column(sa.String(10), default=None, comment='性别(male/female/other)')
    birthday: Mapped[str | None] = mapped_column(sa.String(10), default=None, comment='生日(YYYY-MM-DD)')
    province: Mapped[str | None] = mapped_column(sa.String(64), default=None, comment='省份')
    ...
    industry: Mapped[str | None] = mapped_column(sa.String(128), default=None, comment='行业')
    ...
    is_multi_login: Mapped[bool] = mapped_column(default=True, comment='是否重复登陆(0否 1是)')
